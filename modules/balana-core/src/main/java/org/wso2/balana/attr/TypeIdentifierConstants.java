...
public class TypeIdentifierConstants {
	...
	public static final String DNSNAME = "urn:oasis:names:tc:xacml:2.0:data-type:dnsName";
	...
	public static final String IPADDRESS = "urn:oasis:names:tc:xacml:2.0:data-type:ipAddress";
	...
	public static final URI ANYURI_URI = URI.create(ANYURI);
	public static final URI BASE64BINARY_URI = URI.create(BASE64BINARY);
	public static final URI BOOLEAN_URI = URI.create(BOOLEAN);
	public static final URI DATE_URI = URI.create(DATE);
	public static final URI DATETIME_URI = URI.create(DATETIME);
	public static final URI DAYTIMEDURATION_URI = URI.create(DAYTIMEDURATION);
	public static final URI DECISION_URI = URI.create(DECISION);
	public static final URI DNSNAME_URI = URI.create(DNSNAME);
	public static final URI DOUBLE_URI = URI.create(DOUBLE);
	public static final URI HEXBINARY_URI = URI.create(HEXBINARY);
	public static final URI INTEGER_URI = URI.create(INTEGER);
	public static final URI IPADDRESS_URI = URI.create(IPADDRESS);
	public static final URI RFC822NAME_URI = URI.create(RFC822NAME);
	public static final URI STRING_URI = URI.create(STRING);
	public static final URI TIME_URI = URI.create(TIME);
	public static final URI X500NAME_URI = URI.create(X500NAME);
	public static final URI YEARMONTHDURATION_URI = URI
