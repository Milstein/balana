...
public class Result extends AbstractResult {
	...
	public Result(int decision) throws IllegalArgumentException {
		super(decision, null, XACMLConstants.XACML_VERSION_3_0);
	}
	 ...
	 *             if decision is not valid
	 */
	public Result(int decision, List<ObligationResult> obligations,
			List<Advice> advices) {
		super(decision, null, obligations, advices,
	...
	public void encode(StringBuilder builder) {
		...
		if (decision == 4 || decision == 5 || decision == 6) {
			...
			// "Indeterminate"
			builder.append("<Decision>").append(DECISIONS[2])
					.append("</Decision>");
		} else {
			builder.append("<Decision>").append(DECISIONS[decision])
					.append("</Decision>");
		}
		// encode the status
		if (status != null) {
